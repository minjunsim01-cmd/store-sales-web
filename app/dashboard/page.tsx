...
export default function Dashboard(){
  ...
  return <main className="container">
    <div className="nav no-print"><Link href="/input">매출 입력</Link><Link href="/report">월별 매출표</Link><Link href="/admin/users">직원 관리</Link><button className="nav-button" onClick={logout}>로그아웃</button></div>
    <h1>관리자 대시보드</h1>
